...
public interface ITypeNameR
{
    ...
    string ExtractReadable(Type type);
    ...
    string ExtractReadable(MethodBase methodBase,
    ...
    string ExtractReadable(ParameterInfo parameterInfo,
                           NameRControlFlags nameRControlFlags);
    ...
    string ExtractReadable(StackFrame stackFrame,
                           NameRControlFlags nameRControlFlags);
    ...
    string ExtractReadable(System.Diagnostics.StackTrace stackTrace,
                           NameRControlFlags nameRControlFlags);
    ...
    string ExtractReadableStackTrace(Exception exception,
                                     NameRControlFlags nameRControlFlags);
    ...
    TException RewriteStackTrace<TException>(TException exception,
                                              NameRControlFlags nameRControlFlags)
