...
using ExceptionStackTraceSetter = JanHafner.TypeNameR.StackTrace.UnsafeExceptionStackTraceSetter;
#else
using ExceptionStackTraceSetter = JanHafner.TypeNameR.StackTrace.ReflectionExceptionStackTraceSetter;
#endif
